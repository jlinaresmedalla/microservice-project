...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDetalils> resourceNotFoundExceptionHandler(ResourceNotFoundException exception, WebRequest WebRequest) {
        ErrorDetalils errorDetails = new ErrorDetalils(
                LocalDateTime.now(),
